# Generated by Django 3.2.4 on 2022-12-25 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='recipes.AmountIngredient', verbose_name='Ингредиенты рецепта')),
                ('tags', models.ManyToManyField(related_name='recipes', to='recipes.Tag', verbose_name='Тэги рецепта')),
            ],
            options={
                'verbose_name': 'Рецепт',
